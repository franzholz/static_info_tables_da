# -*- coding: utf-8 -*-
#
# Static Info Tables (da) documentation build configuration file, created by
...
project = u'Static Info Tables (da)'
...
htmlhelp_basename = 'static_info_tables_dadoc'
...
latex_documents = [
    ('Index', 'static_info_tables_da.tex', u'Static Info Tables (da)',
...
pdf_documents = [
    ('Index', 'static_info_tables_da', u'Static Info Tables (da)',
     u'Franz Holzinger'),
]
...
texinfo_documents = [
    ('Index', 'static_info_tables_da', u'Static Info Tables (da)',
     u'Franz Holzinger', 'Static Info Tables (da)', 'One line description of project.',
     'Miscellaneous'),
]
